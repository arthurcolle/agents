...
class CLIAgent:
    ...
    def _init_dynamic_agent_tools(self):
        ...
        # NOTE: The following tools are likely registered via _register_builtin_tools
        # and can be removed from this manual list if registry is the single source of truth.
        # - Data analysis tools (load_csv, plot_data, analyze_text)
        # - Modal tools (list_modal_functions, call_modal_function)
        # - Visualization tools (create_advanced_visualization)
        # - Dynamic agent tools (create_agent, list_agents, execute_agent_command)
        # - Tool management tools (register_tool, unregister_tool, list_tools)
        # - Knowledge base tools (list_knowledge_bases, search_knowledge_base, create_kb_agent)

        # Update self.tools to only use the registry version for consistency
